...
|--------|----------|-------------|
| `create_admin.py` | Créer un utilisateur administrateur | `python scripts/create_admin.py` |
| `cleanup_database.py` | Nettoyer et optimiser la base de données | `python scripts/cleanup_database.py` |
| `update_permissions.py` | Mettre à jour les permissions utilisateurs | `python scripts/update_permissions.py` |
| `init_database.py` | Initialiser la base de données | `python scripts/init_database.py` |
| `create_master_user.py` | Créer un utilisateur maître | `python scripts/create_master_user.py` |
| `remove_user.py` | Supprimer un utilisateur | `python scripts/remove_user.py` |
| `reset_user_passwords.py` | Réinitialiser les mots de passe | `python scripts/reset_user_passwords.py` |

#### Scripts de Maintenance
| Script | Fonction | Utilisation |
|--------|----------|-------------|
| `apply_database_optimizations.py` | Appliquer les optimisations DB | `python scripts/apply_database_optimizations.py` |
| `cleanup_logs.py` | Nettoyer les logs anciens | `python scripts/cleanup_logs.py` |
| `generate_pdfs_for_existing_analyses.py` | Générer PDFs pour analyses existantes | `python scripts/generate_pdfs_for_existing_analyses.py` |
