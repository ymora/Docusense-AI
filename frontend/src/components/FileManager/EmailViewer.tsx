            ...
            <div className="flex items-center space-x-4">
              ...
              >
                {showHeaders ? <EyeSlashIcon className="h-4 w-4" /> : <EyeIcon className="h-4 w-4" />}
                                                                                                                                           ...
                                                                                                                                           {/* Contenu principal avec ascenseur personnalisé */}
                   ...
                   {emailData.html_content.includes('cid:') && (
                     <div className="mb-4 p-3 bg-yellow-900/20 border border-yellow-600/30 rounded-lg">
                       <p className="text-yellow-400 text-sm">
                         ⚠️ Certaines images ou ressources intégrées ne peuvent pas être affichées. 
                         Consultez les pièces jointes ci-dessus.
                       </p>
                     </div>
                   )}
                   <div 
