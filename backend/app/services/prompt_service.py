...
class PromptService(BaseService):
    ...
    @log_service_operation("load_prompts_from_json")
    def _load_prompts_from_json(self) -> Dict[str, Any]:
        """Load prompts from JSON file"""
        return self.safe_execute("load_prompts_from_json", self._load_prompts_logic)
    ...
    @log_service_operation("get_default_prompt")
    def get_default_prompt(self, analysis_type: str) -> Optional[str]:
        """Get default prompt for analysis type"""
        return self.safe_execute("get_default_prompt", self._get_default_prompt_logic, analysis_type)
    ...
    @log_service_operation("get_prompts_by_domain")
    def get_prompts_by_domain(self, domain: PromptDomain) -> Dict[str, Dict[str, Any]]:
        """Get all prompts for a specific domain"""
        return self.safe_execute("get_prompts_by_domain", self._get_prompts_by_domain_logic, domain)
    ...
    @log_service_operation("get_prompts_by_type")
    def get_prompts_by_type(self, prompt_type: PromptType) -> Dict[str, Dict[str, Any]]:
        """Get all prompts of a specific type"""
        return self.safe_execute("get_prompts_by_type", self._get_prompts_by_type_logic, prompt_type)
    ...
    @log_service_operation("get_prompt")
    def get_prompt(self, prompt_id: str) -> Optional[Dict[str, Any]]:
        """Get a specific prompt by ID"""
        return self.safe_execute("get_prompt", self._get_prompt_logic, prompt_id)
    ...
    @log_service_operation("format_prompt")
    def format_prompt(self, prompt_id: str, text: str) -> Optional[str]:
        """Format a prompt with the given text"""
        return self.safe_execute("format_prompt", self._format_prompt_logic, prompt_id, text)
    ...
    @log_service_operation("get_all_prompts")
    def get_all_prompts(self) -> Dict[str, Dict[str, Any]]:
        """Get all available prompts"""
        return self.safe_execute("get_all_prompts", self._get_all_prompts_logic)
    ...
    @log_service_operation("get_all_default_prompts")
    def get_all_default_prompts(self) -> Dict[str, str]:
        """Get all default prompts"""
        return self.safe_execute("get_all_default_prompts", self._get_all_default_prompts_logic)
    ...
    @log_service_operation("get_prompts_summary")
    def get_prompts_summary(self) -> Dict[str, Any]:
        """Get a summary of all prompts organized by domain"""
        return self.safe_execute("get_prompts_summary", self._get_prompts_summary_logic)
    ...
    @log_service_operation("reload_prompts")
    def reload_prompts(self) -> bool:
        """Reload prompts from JSON file"""
        return self.safe_execute("reload_prompts", self._reload_prompts_logic)
