...
class DocumentExtractorService:
    ...
    async def extract_text(self, file_path: str) -> Optional[str]:
        ...
        try:
            ...
            if text:
                logger.info(f"Texte extrait de {file_path.name}: {len(text)} caractères")
                return text
            else:
    ...
    def _extract_from_docx(self, file_path: Path) -> Optional[str]:
        ...
        try:
            ...
            logger.error(f"Erreur extraction DOCX {file_path}: {str(e)}")
            return None
    ...
    def _extract_from_doc(self, file_path: Path) -> Optional[str]:
        ...
        try:
            ...
            logger.error(f"Erreur extraction DOC {file_path}: {str(e)}")
            return None
    ...
    def _extract_from_xlsx(self, file_path: Path) -> Optional[str]:
        ...
        try:
            ...
            logger.error(f"Erreur extraction XLSX {file_path}: {str(e)}")
            return None

    def _extract_from_xls(self, file_path: Path) -> Optional[str]:
        ...
        try:
            ...
            logger.error(f"Erreur extraction XLS {file_path}: {str(e)}")
            return None
    ...
    def _extract_from_csv(self, file_path: Path) -> Optional[str]:
        ...
        try:
            ...
            logger.error(f"Erreur extraction CSV {file_path}: {str(e)}")
            return None
    ...
    def _extract_from_pptx(self, file_path: Path) -> Optional[str]:
        ...
        try:
            ...
            logger.error(f"Erreur extraction PPTX {file_path}: {str(e)}")
            return None

    def _extract_from_ppt(self, file_path: Path) -> Optional[str]:
        ...
        try:
            ...
            logger.error(f"Erreur extraction PPT {file_path}: {str(e)}")
            return None
    ...
    def _extract_from_txt(self, file_path: Path) -> Optional[str]:
        ...
        try:
            ...
            logger.error(f"Erreur extraction TXT {file_path}: {str(e)}")
            return None

    def _extract_from_html(self, file_path: Path) -> Optional[str]:
        ...
        try:
            ...
            logger.error(f"Erreur extraction HTML {file_path}: {str(e)}")
            return None

    def _extract_from_rtf(self, file_path: Path) -> Optional[str]:
        ...
        try:
            ...
            logger.error(f"Erreur extraction RTF {file_path}: {str(e)}")
            return None

    def _extract_from_odt(self, file_path: Path) -> Optional[str]:
        ...
        try:
            ...
            logger.error(f"Erreur extraction ODT {file_path}: {str(e)}")
            return None

    def _extract_from_ods(self, file_path: Path) -> Optional[str]:
        ...
        try:
            ...
            logger.error(f"Erreur extraction ODS {file_path}: {str(e)}")
            return None

    def _extract_from_odp(self, file_path: Path) -> Optional[str]:
        ...
        try:
            ...
            logger.error(f"Erreur extraction ODP {file_path}: {str(e)}")
            return None
